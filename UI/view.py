...
class View:
    ...
    def load_interface(self):
        ...
        #row2
        self.ddArtist = ft.Dropdown(label="Artista", width = 250, on_change=self._controller.handle_connected_artists)
        ...
        self.btnSearchArtists = ft.ElevatedButton(text="Cerca cammino da artista", on_click=self._controller.handle_ricerca)
